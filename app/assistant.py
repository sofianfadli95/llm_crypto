...
def elastic_search_text(query, index_name="crypto-questions"):
    search_query = {
        "size": 5,
        "query": {
            "bool": {
...
def elastic_search_knn(field, vector, index_name="crypto-questions"):
    knn = {
        "field": field,
        "query_vector": vector,
        "k": 5,
...
def get_answer(query, model_choice, search_type):
    if search_type == 'Vector':
        ...
        search_results = elastic_search_knn('question_answer_vector', vector)
    else:
